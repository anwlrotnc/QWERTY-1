...
public class Test_002 : MonoBehaviour
{
    ...
    void Start()
    {
        int answer = 1 + 2;         //변수 int answer 선언
        Debug.Log(answer);          //Console.log() anwser 값을 보여줌
        ...
        answer2 = n1 + n2;          //answer2에 변수 n1 값과 n2값의 더한 값을 입력
        Debug.Log(answer2);         //Console.log() answer2 값을 보여줌

        answer2 += 5;               //answer2= answer2 + 5의 축약 요약
        Debug.Log(answer2);         //Console.log() answer2 값을 보여줌
