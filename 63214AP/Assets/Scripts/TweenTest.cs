...
public class TweenTest : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //transform.DORotate(new Vector3(0, 0, 180), 2);        //180도 2초 회전
        ...
        //sequence.Append(transform.DORotate(new Vector3(0, 0, 180), 2).OnComplete(SequenceEnd));  //완료되면 함수 호출
